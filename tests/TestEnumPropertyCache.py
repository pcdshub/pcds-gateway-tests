...
class TestEnumPropertyCache(unittest.TestCase):
    ...
    def testEnumPropCache_ValueMonitorCTRLget(self):
        ...
        self.assertTrue(
            self.connected == 0,
            "Expected GW connected PV count: 0, actual: " + str(self.connected),
        )
        self.assertTrue(
            self.active == 0,
        ...
        self.assertTrue(
            self.connected == 1,
            "Expected GW connected PV count: 1, actual: " + str(self.connected),
        )
        self.assertTrue(
            self.active == 1,
        ...
        self.assertTrue(
            oneStr == "one", "Expected IOC enum[1]: one; actual enum[1]: " + oneStr
        )
        gw_ctrl = ca.get_ctrlvars(gw)
        oneStr = gw_ctrl["enum_strs"][1]
        self.assertTrue(
            oneStr == "one", "Expected GW enum[1]: one; actual enum[1]: " + oneStr
        )
        ...
        oneStr = ioc_ctrl["enum_strs"][1]
        self.assertTrue(
            oneStr == "uno", "Expected IOC enum[1]: uno; actual enum[1]: " + oneStr
        )
    ...
    def testEnumPropCache_ValueGetDisconnectCTRLGet(self):
        ...
        oneStr = gw_ctrl["enum_strs"][1]
        self.assertTrue(
            oneStr == "uno", "Expected GW enum[1]: uno; actual enum[1]: " + oneStr
        )
